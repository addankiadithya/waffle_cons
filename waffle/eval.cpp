...
eval(Term* t) {
  ...
  case nil_term: return eval_nil(as<Nil>(t));
  case cons_term: return eval_cons(as<Cons>(t));
  ...
  case data_term: return eval_data(as<Data>(t));
