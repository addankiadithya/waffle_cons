...
// Recursive Data Types with "Data"; as in "def" id
constexpr Token_kind data_tok	= make_token(400);
constexpr Token_kind nil_tok	= make_token(401);
constexpr Token_kind cons_tok	= make_token(402);

// Recursive Data types 
constexpr Token_kind mu_type_tok		=make_token(450);
constexpr Token_kind cons_type_tok		=make_token(451);
