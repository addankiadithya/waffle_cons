...
init_types() {
  ...
  mu_type_	= new Mu_type(kind_type_);
  cons_type_= new Cons_type(kind_type_);
...
Type* 
get_mu_type() {return mu_type_;}
Type*
get_cons_type(){ return cons_type_;}
// -------------------------------------------------------------------------- //
// Typing
...
bool 
is_mu_type(Type* t) {return t->kind == mu_type;}

bool 
is_cons_type(Type* t) {return t->kind==cons_type;}
